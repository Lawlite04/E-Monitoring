                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('leader.home')" :active="route().current('leader.home')">
                                    Leader
                                </NavLink>
                                <NavLink :href="route('client.home')" :active="route().current('client.home')">
                                    Client
                                </NavLink>
                                <NavLink :href="route('project.home')" :active="route().current('project.home')">
                                    Project
                                </NavLink>
                            </div>
                        </div>
